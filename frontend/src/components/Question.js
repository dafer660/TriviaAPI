        ...
        return (
            <div className="Question-holder">
                ...
                <div className="Question-status">
                    ...
                    <div className="difficulty">Difficulty: <span className="questionItem">{difficulty}</span></div>
                    <div className="rating">Rating: <span className="questionItem">{rating != null ? rating : <span>&#8709;</span>}</span> </div>
